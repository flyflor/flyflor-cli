...
This directory stores retired `flyflor-cli` documentation snapshots. Archived files explain prior decisions but do not define active CLI or kernel behavior.

Current behavior is defined by the root `README.md`, root `README.zh.cn.md`, and the active docs under `docs/`.
