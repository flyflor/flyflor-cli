...
## 2026-05-28 TUI Catalog Polish i18n Cleanup 主控切片

本轮未新增实现型子 Codex；由主控在主 worktree 清理 compact sidebar、旧 layout header 和 zh-CN catalog 中仍暴露英文的生产 UI 文案。沿用固定 lane 表，当前可用下列命令查看历史 session 或验证细节：
