...
pub const PLATFORMS: &[PlatformMetadata] = &[
    ...
    PlatformMetadata {
        ...
        details: &[
            "message event webhook payload",
            "text reply/send",
            "interactive card updates",
            "tenant access token",
            "approvals/files/slash commands unavailable",
        ],
    },
    PlatformMetadata {
        name: "dingtalk",
        ...
        optional_env: &[
            ...
            "DINGTALK_HOME_CONVERSATION_ID",
            "DINGTALK_INBOUND_WEBHOOK",
            "DINGTALK_APP_KEY",
            "DINGTALK_APP_SECRET",
        ],
        env_aliases: &[
        ...
        status: PlatformRuntimeStatus::Native,
        capability: cap!(group_chat, quote_reply, webhook_required, oauth),
        details: &[
            "incoming session webhook payload",
            "text session webhook reply",
            "robot group text send",
            "access token OpenAPI",
            "AI cards/stream/media unavailable",
        ],
    },
    PlatformMetadata {
        name: "wecom",
        ...
        status: PlatformRuntimeStatus::Native,
        capability: cap!(group_chat, quote_reply, websocket),
        details: &[
            "AI Bot callback payload",
            "AI Bot WebSocket markdown send",
            "group/direct text routing",
            "media/typing/edit unavailable",
        ],
    },
    PlatformMetadata {
        name: "wecom-callback",
        ...
        status: PlatformRuntimeStatus::Native,
        capability: cap!(direct_message, webhook_required, oauth),
        details: &[
            "env callback payload",
            "Corp API text send",
            "access token OpenAPI",
            "encrypted XML/server unavailable",
        ],
    },
    PlatformMetadata {
        name: "weixin",
    ...
    PlatformMetadata {
        ...
        capability: cap!(group_chat, quote_reply, webhook_required, oauth),
        details: &[
            "env gateway event payload",
            "Official API v2 text send",
            "group/direct/guild route",
            "rate-limit classification",
            "WebSocket/QR/media unavailable",
        ],
    },
    PlatformMetadata {
        name: "email",
    ...
    PlatformMetadata {
        ...
        status: PlatformRuntimeStatus::Native,
        capability: cap!(threads, group_chat, webhook_required),
        details: &[
            "Bot Framework activity payload",
            "incoming webhook replies",
            "Graph text fallback",
            "channel posts metadata",
        ],
    },
    PlatformMetadata {
        ...
        optional_env: &[
            ...
            "MSGRAPH_REPLY_WEBHOOK_URL",
            "MSGRAPH_WEBHOOK_INBOUND_EVENT",
            "MSGRAPH_HOME_CHANNEL",
        ],
        env_aliases: &[
            "MSGRAPH_TENANT_ID",
            "MSGRAPH_CLIENT_ID",
        ...
        status: PlatformRuntimeStatus::Native,
        capability: cap!(webhook_required, oauth),
        details: &[
    ...
    PlatformMetadata {
        ...
        status: PlatformRuntimeStatus::Native,
        capability: cap!(threads, group_chat, quote_reply, oauth, polling),
        details: &[
            "Pub/Sub message payload",
            "Chat REST text send",
            "thread replies",
            "cards/media unavailable",
        ],
    },
    PlatformMetadata {
        name: "irc",
    ...
    PlatformMetadata {
        ...
        status: PlatformRuntimeStatus::Native,
        capability: cap!(group_chat, quote_reply, webhook_required),
        details: &[
            "env signal-cli envelope",
            "JSON-RPC text send",
            "direct/group route",
            "media/typing/reactions unavailable",
        ],
    },
    PlatformMetadata {
        name: "sms",
